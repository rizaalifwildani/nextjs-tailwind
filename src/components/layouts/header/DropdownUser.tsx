...
import Toastify from "@/libs/tostify"
import AuthService from "@/services/auth.service"
import AvatarNameUtil from "@/utils/avatarName.util"
      ...
      <div className="relative">
        ...
        >
          <span className="hidden text-right lg:block">
            ...
            <span className="block text-xs">{profile.role.displayName}</span>
          </span>

          <div className="relative inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-stroke shadow-sm shadow-stroke">
            <span className="font-medium text-black">
              {AvatarNameUtil(profile.name)}
            </span>
          </div>
